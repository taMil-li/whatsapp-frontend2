...
function App() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3001/messages/${CURRENT_USER_ID}/${OTHER_USER_ID}`)
            .then(response => {
    ...
    const handleSendMessage = (e) => {
        ...
        setMessages(prevMessages => [
            ...prevMessages,
            { sender_id: CURRENT_USER_ID, content: newMessage, created_at: new Date() }
        ]);
            ...
            <div className="chat-window">
                ...
                <main className="message-list">
                    ...
                    messages.map((msg, index) => {
                        ...
                        <div
                            key={index}
                            className={`message-bubble ${msg.sender_id === CURRENT_USER_ID ? 'sent' : 'received'}`}
                        >
                            <p>{msg.content}</p>
